export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji LockedCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} LockedCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
