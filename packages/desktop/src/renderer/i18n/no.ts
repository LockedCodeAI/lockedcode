export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av LockedCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av LockedCode er lastet ned. Vil du installere den og starte på nytt?",
