export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von LockedCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von LockedCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
