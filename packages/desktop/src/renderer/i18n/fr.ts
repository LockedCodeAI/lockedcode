export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'LockedCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'LockedCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
