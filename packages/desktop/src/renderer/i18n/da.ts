export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af LockedCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af LockedCode er blevet downloadet. Vil du installere den og genstarte?",
