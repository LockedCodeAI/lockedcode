export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju LockedCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} LockedCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
