 ...
 *   {
 *     password: Config.string("LOCKEDCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("LOCKEDCODE_SERVER_USERNAME").pipe(Config.withDefault("lockedcode")),
 *   },
 * ) {}
 *
