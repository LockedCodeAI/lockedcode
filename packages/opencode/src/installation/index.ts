    ...
    Effect.gen(function* () {
      ...
      const upgradeCurl = Effect.fnUntraced(
        function* (target: string) {
          const response = yield* httpOk.execute(HttpClientRequest.get("https://lockedcode.ai/install"))
      ...
      const result: Interface = {
        ...
        method: Effect.fn("Installation.method")(function* () {
          ...
          const checks: Array<{ name: Method; command: () => Effect.Effect<string> }> = [
            ...
            { name: "brew", command: () => text(["brew", "list", "--formula", "lockedcode"]) },
            { name: "scoop", command: () => text(["scoop", "list", "lockedcode"]) },
            { name: "choco", command: () => text(["choco", "list", "--limit-output", "lockedcode"]) },
          ]
          ...
          for (const check of checks) {
            ...
            const installedName =
              check.name === "brew" || check.name === "choco" || check.name === "scoop" ? "lockedcode" : "lockedcode-ai"
