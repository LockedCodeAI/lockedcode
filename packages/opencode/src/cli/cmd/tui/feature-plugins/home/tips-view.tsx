...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at lockedcode.ai",
  ...
  "Create {highlight}lockedcode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/lockedcode/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "LockedCode auto-handles OAuth for remote MCP servers requiring auth",
  "LockedCode auto-formats files using prettier, gofmt, ruff, and more",
  "LockedCode uses LSP servers for intelligent code analysis",
  ...
  "Use {highlight}lockedcode run{/highlight} for non-interactive scripting",
  "Use {highlight}lockedcode --continue{/highlight} to resume the last session",
  "Use {highlight}lockedcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}lockedcode serve{/highlight} for headless API access to LockedCode",
  "Use {highlight}lockedcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}lockedcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}lockedcode auth list{/highlight} to see all configured providers",
  "Run {highlight}lockedcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}lockedcode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}lockedcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/LockedCodeAI/lockedcode{/highlight} for containerized use",
